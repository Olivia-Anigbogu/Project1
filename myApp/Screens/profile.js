...
import { View, StyleSheet, ScrollView, Text, Pressable, ImageBackground } from 'react-native';
    ...
    <ImageBackground source={require('../assets/books.jpg')} style={styles.container}>
      <ScrollView style={styles.mainView}>
        ...
        <View style={{ padding: '20px' }}>
          ...
          <Text style={{ marginTop: 10, paddingLeft: '20px', textTransform: "capitalize" }}>{Name}</Text>
        </View>
        ...
        <View style={{ padding: '20px' }}>
          ...
          <Text style={{ marginTop: 10, paddingLeft: '20px' }}>{PhoneNumber}</Text>
        </View>
        {/* Display a horizontal line */}
        <View style={{ borderBottomWidth: 1, width: '92%', alignSelf: "center", backgroundColor: "red" }}></View>
        {/* <View style={{padding:'20px'}}> */}
        ...
        <Pressable onPress={goToFAQ}>
          <View>
            <Text style={{ marginTop: 10, paddingLeft: '20px', paddingBottom: '20px' }}>Faq</Text>
          </View>
          {/* Display a horizontal line */}
          <View style={{ borderBottomWidth: 1, width: '92%', alignSelf: "center", backgroundColor: "red" }}></View><br />
        </Pressable>
        <Pressable onPress={goToPrivacy}>
          <View>
            <Text style={{ marginTop: 10, paddingLeft: '20px', paddingBottom: '20px' }}>Privacy Policy</Text>
          </View>
          {/* Display a horizontal line */}
          <View style={{ borderBottomWidth: 1, width: '92%', alignSelf: "center", backgroundColor: "red" }}></View><br />
        </Pressable>
        <Pressable onPress={goToIndex}>
          <View>
            <Text style={{ marginTop: 10, paddingLeft: '20px', paddingBottom: '20px' }}>Log Out</Text>
          </View>
          {/* Display a horizontal line */}
          <View style={{ borderBottomWidth: 1, width: '92%', alignSelf: "center", backgroundColor: "red" }}></View><br />
        </Pressable>
