  ...
  return (
    <ScrollView>
      ...
      <Text>
        ...
        {"\n"}
        {"\n"}
        This privacy notice for Read More ('Company', 'we', 'us', or 'our'),
        describes how and why we might collect, store, use, and/or share
        ('process') your information when you use our services ('Services'),
        such as when you: Download and use our mobile application (ReadMore), or
        any other application of ours that links to this privacy notice Engage
        ...
        information depending on how you interact with Read More and the
        ...
        {"\n"}
        <b>
          Want to learn more about what Read More does with any information we
          collect?
        </b>{" "}
        {"\n"}
        ...
        phone numbers email addresses usernames passwords Sensitive Information.
        ...
        and prevention. To comply with our legal obligations. We may process
        your information to comply with our legal obligations, respond to legal
        ...
        {"\n"}
        <b>6. WHAT ARE YOUR PRIVACY RIGHTS?</b>
        {"\n"}
        ...
        email us at oliviaanigbogu860@gmail.com.
        {"\n"}
        <b>7. CONTROLS FOR DO-NOT-TRACK FEATURES</b>
        {"\n"}
        ...
        oliviaanigbogu860@gmail.com or contact us by post at:
        {"\n"}
        Read More Nigeria
        {"\n"}
        <b>
